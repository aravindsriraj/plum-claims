...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: another_prescription.jpg: read as PRESCRIPTION (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F002: extracted via METADATA (confidence 0.50)
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: blurry_bill.jpg: read as PHARMACY_BILL (quality UNREADABLE, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F004: extracted via METADATA (confidence 0.50)
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: bill_arjun.jpg: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F006: extracted via METADATA (confidence 0.50)
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F008: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F008: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [PASS] CrossValidationAgent: Patient name 'Rajesh Kumar' consistent across documents.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹1,500).
   11. [PASS] CrossValidationAgent: Prescription present.
   12. [PASS] AdjudicationEngine: Member validity: Member EMP001 found in policy roster.
   ...
   15. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹1,500 meets the minimum of ₹500.
   16. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-11-01 is on/after the end of the 30-day initial waiting period (2024-05-01).
   ...
   20. [PASS] AdjudicationEngine: Per-claim limit: Claimed ₹1,500 is within the per-claim limit of ₹5,000.
   21. [PASS] AdjudicationEngine: COPAY: ₹1,500 -> ₹1,350. Co-pay (10%) applied: member bears ₹150, insurer pays ₹1,350.
   22. [PASS] AdjudicationEngine: Financial summary: eligible ₹1,500 -> approved ₹1,350.
   ...
   26. [PASS] DecisionSynthesizer: Decision: APPROVED — approved ₹1,350, confidence 0.98.
```
</details>
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F010: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F010: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [PASS] CrossValidationAgent: Patient name 'Vikram Joshi' consistent across documents.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹3,000).
   11. [PASS] CrossValidationAgent: Prescription present.
   12. [PASS] AdjudicationEngine: Member validity: Member EMP005 found in policy roster.
   13. [PASS] AdjudicationEngine: Category coverage: CONSULTATION is a covered category under this policy.
   14. [SKIP] AdjudicationEngine: Submission deadline: NOT_EVALUATED (no submission_date provided).
   15. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹3,000 meets the minimum of ₹500.
   16. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-10-15 is on/after the end of the 30-day initial waiting period (2024-10-01).
   17. [PASS] AdjudicationEngine: Policy exclusions: No policy exclusion matches the diagnosis/treatment.
   18. [FAIL] AdjudicationEngine: Waiting period — diabetes: diabetes: 90-day waiting period not served. Eligible from 2024-11-30.
...
Pipeline trace:
    ...
    3. [PASS] ExtractionAgent: F011: extracted via PROVIDED_CONTENT (confidence 1.00)
    4. [PASS] DocumentVerificationAgent: Document set satisfies DENTAL requirements (required: ['HOSPITAL_BILL']).
    5. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    6. [PASS] CrossValidationAgent: Patient name 'Priya Singh' consistent across documents.
    7. [PASS] CrossValidationAgent: Document dates checked against treatment date.
    8. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹12,000).
...
Pipeline trace:
    ...
    2. [PASS] DocumentVerificationAgent: F014: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    3. [PASS] ExtractionAgent: F014: extracted via PROVIDED_CONTENT (confidence 1.00)
    4. [PASS] DocumentVerificationAgent: F013: read as LAB_REPORT (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F013: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: F012: read as PRESCRIPTION (quality GOOD, confidence 1.00, via METADATA).
    7. [PASS] ExtractionAgent: F012: extracted via PROVIDED_CONTENT (confidence 1.00)
   ...
   10. [WARN] CrossValidationAgent: No patient name could be extracted from any document.
   11. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   12. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹15,000).
   13. [PASS] CrossValidationAgent: Prescription present.
   14. [PASS] AdjudicationEngine: Member validity: Member EMP007 found in policy roster.
   15. [PASS] AdjudicationEngine: Category coverage: DIAGNOSTIC is a covered category under this policy.
   16. [SKIP] AdjudicationEngine: Submission deadline: NOT_EVALUATED (no submission_date provided).
   17. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹15,000 meets the minimum of ₹500.
   18. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-11-02 is on/after the end of the 30-day initial waiting period (2024-05-01).
   ...
   21. [FAIL] AdjudicationEngine: Pre-authorization: 'MRI Lumbar Spine' (MRI, ₹15,000) is a high-value test requiring pre-authorization above ₹10,000. No pre-authorization reference was submitted. The member should obtain pre-authorization from the insurer and resubmit the claim with the pre-auth reference number.
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F016: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F016: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [WARN] CrossValidationAgent: No patient name could be extracted from any document.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹7,500).
   11. [PASS] CrossValidationAgent: Prescription present.
   12. [PASS] AdjudicationEngine: Member validity: Member EMP003 found in policy roster.
   13. [PASS] AdjudicationEngine: Category coverage: CONSULTATION is a covered category under this policy.
   14. [SKIP] AdjudicationEngine: Submission deadline: NOT_EVALUATED (no submission_date provided).
   15. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹7,500 meets the minimum of ₹500.
   16. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-10-20 is on/after the end of the 30-day initial waiting period (2024-05-01).
   17. [PASS] AdjudicationEngine: Policy exclusions: No policy exclusion matches the diagnosis/treatment.
   18. [SKIP] AdjudicationEngine: Specific waiting periods: no waiting-listed condition detected (conditions checked: none matched).
   19. [PASS] AdjudicationEngine: Pre-authorization: No pre-authorization required for this claim.
   20. [FAIL] AdjudicationEngine: Per-claim limit: Claimed amount ₹7,500 exceeds the per-claim limit of ₹5,000.
   21. [PASS] FraudAgent: No fraud signals detected.
   22. [PASS] FraudAgent: Fraud score 0.00; manual review not required.
   23. [PASS] DecisionSynthesizer: Confidence computed: 0.98 (extraction quality x component-failure penalties).
...
Pipeline trace:
    ...
    3. [PASS] ExtractionAgent: F017: extracted via PROVIDED_CONTENT (confidence 1.00)
    4. [PASS] DocumentVerificationAgent: F018: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F018: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [WARN] CrossValidationAgent: No patient name could be extracted from any document.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹4,800).
   11. [PASS] CrossValidationAgent: Prescription present.
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F020: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F020: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [PASS] CrossValidationAgent: Patient name 'Deepak Shah' consistent across documents.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹4,500).
   11. [PASS] CrossValidationAgent: Prescription present.
   12. [PASS] AdjudicationEngine: Member validity: Member EMP010 found in policy roster.
   13. [PASS] AdjudicationEngine: Category coverage: CONSULTATION is a covered category under this policy.
   14. [SKIP] AdjudicationEngine: Submission deadline: NOT_EVALUATED (no submission_date provided).
   15. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹4,500 meets the minimum of ₹500.
   16. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-11-03 is on/after the end of the 30-day initial waiting period (2024-05-01).
   17. [PASS] AdjudicationEngine: Policy exclusions: No policy exclusion matches the diagnosis/treatment.
   18. [SKIP] AdjudicationEngine: Specific waiting periods: no waiting-listed condition detected (conditions checked: none matched).
   19. [PASS] AdjudicationEngine: Pre-authorization: No pre-authorization required for this claim.
   20. [PASS] AdjudicationEngine: Per-claim limit: Claimed ₹4,500 is within the per-claim limit of ₹5,000.
   21. [PASS] AdjudicationEngine: Provider 'Apollo Hospitals' is a network hospital.
   22. [PASS] AdjudicationEngine: NETWORK_DISCOUNT: ₹4,500 -> ₹3,600. Network discount (20%) applied: ₹4,500 -> ₹3,600.
   23. [PASS] AdjudicationEngine: COPAY: ₹3,600 -> ₹3,240. Co-pay (10%) applied: member bears ₹360, insurer pays ₹3,240.
   24. [PASS] AdjudicationEngine: Financial summary: eligible ₹4,500 -> approved ₹3,240.
   25. [PASS] FraudAgent: No fraud signals detected.
   26. [PASS] FraudAgent: Fraud score 0.00; manual review not required.
   27. [PASS] DecisionSynthesizer: Confidence computed: 0.98 (extraction quality x component-failure penalties).
   28. [PASS] DecisionSynthesizer: Decision: APPROVED — approved ₹3,240, confidence 0.98.
```
</details>
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F022: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F022: extracted via PROVIDED_CONTENT (confidence 1.00)
    ...
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [FAIL] CrossValidationAgent: Component failed and was skipped: RuntimeError: Simulated component failure (fault injection). Fallback: consistency checks skipped; decision made on extracted data only.
...
Pipeline trace:
    ...
    4. [PASS] DocumentVerificationAgent: F024: read as HOSPITAL_BILL (quality GOOD, confidence 1.00, via METADATA).
    5. [PASS] ExtractionAgent: F024: extracted via PROVIDED_CONTENT (confidence 1.00)
    6. [PASS] DocumentVerificationAgent: Document set satisfies CONSULTATION requirements (required: ['PRESCRIPTION', 'HOSPITAL_BILL']).
    7. [SKIP] ClinicalTaggingAgent: No LLM configured — clinical agent skipped; deterministic tags retained.
    8. [WARN] CrossValidationAgent: No patient name could be extracted from any document.
    9. [PASS] CrossValidationAgent: Document dates checked against treatment date.
   10. [PASS] CrossValidationAgent: Claimed amount matches bill total (₹8,000).
   11. [PASS] CrossValidationAgent: Prescription present.
   12. [PASS] AdjudicationEngine: Member validity: Member EMP009 found in policy roster.
   13. [PASS] AdjudicationEngine: Category coverage: CONSULTATION is a covered category under this policy.
   14. [SKIP] AdjudicationEngine: Submission deadline: NOT_EVALUATED (no submission_date provided).
   15. [PASS] AdjudicationEngine: Minimum claim amount: Claimed ₹8,000 meets the minimum of ₹500.
   16. [PASS] AdjudicationEngine: Initial waiting period: Treatment date 2024-10-18 is on/after the end of the 30-day initial waiting period (2024-05-01).
   17. [FAIL] AdjudicationEngine: Policy exclusions: Treatment relates to 'Morbid Obesity — BMI 37', which falls under the policy exclusion 'Obesity and weight loss programs'. Excluded conditions are never payable under this policy.
   18. [SKIP] AdjudicationEngine: Claim excluded — remaining hard checks not evaluated (an excluded condition is never payable).
   19. [PASS] FraudAgent: No fraud signals detected.
   20. [PASS] FraudAgent: Fraud score 0.00; manual review not required.
   21. [PASS] DecisionSynthesizer: Confidence computed: 0.98 (extraction quality x component-failure penalties).
   22. [FAIL] DecisionSynthesizer: Decision: REJECTED — approved ₹0, confidence 0.98.
